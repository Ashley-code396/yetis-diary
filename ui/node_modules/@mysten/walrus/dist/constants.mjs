...
const SLIVER_STATUS_CHECK_THRESHOLD = 5560;
...
//#endregion
export { MAINNET_WALRUS_PACKAGE_CONFIG, SLIVER_STATUS_CHECK_THRESHOLD, TESTNET_WALRUS_PACKAGE_CONFIG, statusLifecycleRank };
