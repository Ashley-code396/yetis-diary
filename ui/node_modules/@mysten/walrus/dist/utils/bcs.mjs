...
const BlobMetadata = bcs.enum("BlobMetadata", { V1: BlobMetadataV1 });
...
let IntentType = /* @__PURE__ */ function(IntentType$1) {
	IntentType$1[IntentType$1["PROOF_OF_POSSESSION_MSG"] = 0] = "PROOF_OF_POSSESSION_MSG";
	IntentType$1[IntentType$1["BLOB_CERT_MSG"] = 1] = "BLOB_CERT_MSG";
	IntentType$1[IntentType$1["INVALID_BLOB_ID_MSG"] = 2] = "INVALID_BLOB_ID_MSG";
	IntentType$1[IntentType$1["SYNC_SHARD_MSG"] = 3] = "SYNC_SHARD_MSG";
	return IntentType$1;
}({});
...
const BlobPersistenceType = bcs.enum("BlobPersistenceType", {
	Permanent: null,
	Deletable: bcs.struct("Deletable", { objectId: bcs.Address })
});
...
const QuiltPatchTags = bcs.map(bcs.string(), bcs.string()).transform({
	input: (tags) => tags instanceof Map ? tags : new Map(Object.entries(tags)),
...
const QuiltIndexV1 = bcs.struct("QuiltIndexV1", { patches: bcs.vector(QuiltPatchV1) });
...
const CertificateBcs = bcs.struct("Certificate", {
	signers: bcs.vector(bcs.u16()),
	serializedMessage: bcs.byteVector(),
	signature: bcs.byteVector()
});
function parseCertificateFromBase64(base64) {
...
//#endregion
export { BlobId, BlobMetadata, BlobMetadataWithId, CertificateBcs, Field, IntentType, QuiltIndexV1, QuiltPatchBlobHeader, QuiltPatchId, QuiltPatchTags, SliverData, StorageConfirmation, blobIdFromBytes, blobIdFromInt, blobIdToInt, parseCertificateFromBase64 };
