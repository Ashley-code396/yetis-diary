...
var sha256 = createHasher2(
  () => new _SHA256(),
  oidNist2(1)
);
var sha224 = createHasher2(
  () => new _SHA224(),
  oidNist2(4)
);
var sha512 = createHasher2(
  () => new _SHA512(),
  oidNist2(3)
);
var sha384 = createHasher2(
  () => new _SHA384(),
  oidNist2(2)
);
var sha512_256 = createHasher2(
  () => new _SHA512_256(),
  oidNist2(6)
);
var sha512_224 = createHasher2(
  () => new _SHA512_224(),
  oidNist2(5)
);
...
function isValidBIP32Path(path) {
  if (!new RegExp("^m\\/(54|74)'\\/784'\\/[0-9]+'\\/[0-9]+\\/[0-9]+$").test(path)) return false;
  return true;
}
...
var SHA2_32B2 = class extends HashMD3 {
  constructor(outputLen) {
    super(64, outputLen, 8, false);
  }
  get() {
...
var _SHA2242 = class extends SHA2_32B2 {
  constructor() {
    super(28);
    __publicField(this, "A", SHA224_IV3[0] | 0);
    __publicField(this, "B", SHA224_IV3[1] | 0);
    __publicField(this, "C", SHA224_IV3[2] | 0);
    __publicField(this, "D", SHA224_IV3[3] | 0);
    __publicField(this, "E", SHA224_IV3[4] | 0);
    __publicField(this, "F", SHA224_IV3[5] | 0);
    __publicField(this, "G", SHA224_IV3[6] | 0);
    __publicField(this, "H", SHA224_IV3[7] | 0);
  }
};
var K5122 = (() => split3([
  "0x428a2f98d728ae22",
...
var _SHA5122 = class extends SHA2_64B2 {
  constructor() {
    super(64);
    __publicField(this, "Ah", SHA512_IV3[0] | 0);
    __publicField(this, "Al", SHA512_IV3[1] | 0);
    __publicField(this, "Bh", SHA512_IV3[2] | 0);
    __publicField(this, "Bl", SHA512_IV3[3] | 0);
    __publicField(this, "Ch", SHA512_IV3[4] | 0);
    __publicField(this, "Cl", SHA512_IV3[5] | 0);
    __publicField(this, "Dh", SHA512_IV3[6] | 0);
    __publicField(this, "Dl", SHA512_IV3[7] | 0);
    __publicField(this, "Eh", SHA512_IV3[8] | 0);
    __publicField(this, "El", SHA512_IV3[9] | 0);
    __publicField(this, "Fh", SHA512_IV3[10] | 0);
    __publicField(this, "Fl", SHA512_IV3[11] | 0);
    __publicField(this, "Gh", SHA512_IV3[12] | 0);
    __publicField(this, "Gl", SHA512_IV3[13] | 0);
    __publicField(this, "Hh", SHA512_IV3[14] | 0);
    __publicField(this, "Hl", SHA512_IV3[15] | 0);
  }
};
var _SHA3842 = class extends SHA2_64B2 {
  constructor() {
    super(48);
    __publicField(this, "Ah", SHA384_IV3[0] | 0);
    __publicField(this, "Al", SHA384_IV3[1] | 0);
    __publicField(this, "Bh", SHA384_IV3[2] | 0);
    __publicField(this, "Bl", SHA384_IV3[3] | 0);
    __publicField(this, "Ch", SHA384_IV3[4] | 0);
    __publicField(this, "Cl", SHA384_IV3[5] | 0);
    __publicField(this, "Dh", SHA384_IV3[6] | 0);
    __publicField(this, "Dl", SHA384_IV3[7] | 0);
    __publicField(this, "Eh", SHA384_IV3[8] | 0);
    __publicField(this, "El", SHA384_IV3[9] | 0);
    __publicField(this, "Fh", SHA384_IV3[10] | 0);
    __publicField(this, "Fl", SHA384_IV3[11] | 0);
    __publicField(this, "Gh", SHA384_IV3[12] | 0);
    __publicField(this, "Gl", SHA384_IV3[13] | 0);
    __publicField(this, "Hh", SHA384_IV3[14] | 0);
    __publicField(this, "Hl", SHA384_IV3[15] | 0);
  }
};
...
var sha2563 = createHasher3(
  () => new _SHA2562(),
  oidNist3(1)
);
var sha2242 = createHasher3(
  () => new _SHA2242(),
  oidNist3(4)
);
var sha5123 = createHasher3(
  () => new _SHA5122(),
  oidNist3(3)
);
var sha3843 = createHasher3(
  () => new _SHA3842(),
  oidNist3(2)
);
var sha512_2562 = createHasher3(
  () => new _SHA512_2562(),
  oidNist3(6)
);
var sha512_2242 = createHasher3(
  () => new _SHA512_2242(),
  oidNist3(5)
);
...
function createHasher4(Point, mapToCurve, defaults) {
  ...
  const snapshot = (src) => Object.freeze({
    ...src,
    DST: isBytes3(src.DST) ? copyBytes(src.DST) : src.DST,
    ...src.encodeDST === void 0 ? {} : { encodeDST: isBytes3(src.encodeDST) ? copyBytes(src.encodeDST) : src.encodeDST }
  });
...
function createFROST(opts) {
  ...
  const serializeIdentifier = (id) => bytesToHex3(Fn.toBytes(validateIdentifier(id)));
  const parseIdentifier = (id) => {
    const n = validateIdentifier(Fn.fromBytes(hexToBytes3(id)));
  ...
  const generateNonce = (secret, rng = randomBytes3) => H3(concatBytes2(rng(32), Fn.toBytes(secret)));
  ...
  const frost = {
    ...
    utils: Object.freeze({
      ...
      randomScalar: (rng = randomBytes3) => Fn.toBytes(genPointScalarPair(rng).scalar),
...
function SWUFpSqrtRatio(Fp, Z) {
  ...
  const q = F.ORDER;
  let l = _0n4;
  for (let o = q - _1n5; o % _2n2 === _0n4; o /= _2n2)
    l += _1n5;
  const c1 = l;
...
function ecdsa(Point, hash, ecdsaOpts = {}) {
  ...
  const hmac4 = ecdsaOpts.hmac === void 0 ? (key, msg) => hmac3(hash_, key, msg) : ecdsaOpts.hmac;
  const { Fp, Fn } = Point;
  ...
  const hasLargeRecoveryLifts = CURVE_ORDER * _2n2 + _1n5 < Fp.ORDER;
  ...
  function sign(message, secretKey, opts = {}) {
    ...
    const drbg = createHmacDrbg(hash_.outputLen, Fn.BYTES, hmac4);
...
var p256 = ecdsa(p256_Point, sha2563);
var p256_hasher = (() => {
...
var p384 = ecdsa(p384_Point, sha3843);
var p384_hasher = (() => {
...
var p521 = ecdsa(p521_Point, sha5123);
var p521_hasher = (() => {
...
// ../node_modules/@mysten/sui/node_modules/@noble/hashes/sha2.js
...
var SHA2_32B3 = class extends HashMD {
  constructor(outputLen) {
    super(64, outputLen, 8, false);
  }
  get() {
  ...
  process(view, offset) {
    ...
    for (let i = 0; i < 64; i++) {
      ...
      const T1 = H + sigma1 + Chi(E, F, G) + SHA256_K3[i] + SHA256_W3[i] | 0;
...
var _SHA2243 = class extends SHA2_32B3 {
  constructor() {
    super(28);
...
var SHA2_64B3 = class extends HashMD {
  constructor(outputLen) {
    super(128, outputLen, 16, false);
  }
  // prettier-ignore
  ...
  process(view, offset) {
    ...
    for (let i = 16; i < 80; i++) {
      ...
      const SUMl = add4L(s0l, s1l, SHA512_W_L3[i - 7], SHA512_W_L3[i - 16]);
      const SUMh = add4H(SUMl, s0h, s1h, SHA512_W_H3[i - 7], SHA512_W_H3[i - 16]);
    ...
    for (let i = 0; i < 80; i++) {
      ...
      const CHIh = Eh & Fh ^ ~Eh & Gh;
      const CHIl = El & Fl ^ ~El & Gl;
      const T1ll = add5L(Hl, sigma1l, CHIl, SHA512_Kl3[i], SHA512_W_L3[i]);
      const T1h = add5H(T1ll, Hh, sigma1h, CHIh, SHA512_Kh3[i], SHA512_W_H3[i]);
      const T1l = T1ll | 0;
...
var _SHA5123 = class extends SHA2_64B3 {
  constructor() {
    super(64);
...
var _SHA3843 = class extends SHA2_64B3 {
  constructor() {
    super(48);
...
var _SHA512_2243 = class extends SHA2_64B3 {
  constructor() {
    super(28);
    __publicField(this, "Ah", T224_IV3[0] | 0);
    __publicField(this, "Al", T224_IV3[1] | 0);
    __publicField(this, "Bh", T224_IV3[2] | 0);
    __publicField(this, "Bl", T224_IV3[3] | 0);
    __publicField(this, "Ch", T224_IV3[4] | 0);
    __publicField(this, "Cl", T224_IV3[5] | 0);
    __publicField(this, "Dh", T224_IV3[6] | 0);
    __publicField(this, "Dl", T224_IV3[7] | 0);
    __publicField(this, "Eh", T224_IV3[8] | 0);
    __publicField(this, "El", T224_IV3[9] | 0);
    __publicField(this, "Fh", T224_IV3[10] | 0);
    __publicField(this, "Fl", T224_IV3[11] | 0);
    __publicField(this, "Gh", T224_IV3[12] | 0);
    __publicField(this, "Gl", T224_IV3[13] | 0);
    __publicField(this, "Hh", T224_IV3[14] | 0);
    __publicField(this, "Hl", T224_IV3[15] | 0);
  }
};
var _SHA512_2563 = class extends SHA2_64B3 {
  constructor() {
    super(32);
    __publicField(this, "Ah", T256_IV3[0] | 0);
    __publicField(this, "Al", T256_IV3[1] | 0);
    __publicField(this, "Bh", T256_IV3[2] | 0);
    __publicField(this, "Bl", T256_IV3[3] | 0);
    __publicField(this, "Ch", T256_IV3[4] | 0);
    __publicField(this, "Cl", T256_IV3[5] | 0);
    __publicField(this, "Dh", T256_IV3[6] | 0);
    __publicField(this, "Dl", T256_IV3[7] | 0);
    __publicField(this, "Eh", T256_IV3[8] | 0);
    __publicField(this, "El", T256_IV3[9] | 0);
    __publicField(this, "Fh", T256_IV3[10] | 0);
    __publicField(this, "Fl", T256_IV3[11] | 0);
    __publicField(this, "Gh", T256_IV3[12] | 0);
    __publicField(this, "Gl", T256_IV3[13] | 0);
    __publicField(this, "Hh", T256_IV3[14] | 0);
    __publicField(this, "Hl", T256_IV3[15] | 0);
  }
};
var sha2564 = createHasher(
  () => new _SHA2563(),
  oidNist(1)
);
var sha2243 = createHasher(
  () => new _SHA2243(),
  oidNist(4)
);
var sha5124 = createHasher(
  () => new _SHA5123(),
  oidNist(3)
);
var sha3844 = createHasher(
  () => new _SHA3843(),
  oidNist(2)
);
var sha512_2563 = createHasher(
  () => new _SHA512_2563(),
  oidNist(6)
);
var sha512_2243 = createHasher(
  () => new _SHA512_2243(),
  oidNist(5)
);
...
var PasskeyPublicKey = (_a = class extends PublicKey {
  ...
  */
  async verify(message, signature) {
    ...
    const payload = new Uint8Array([...parsed.authenticatorData, ...sha2564(new TextEncoder().encode(parsed.clientDataJson))]);
...
*/
//# sourceMappingURL=chunk-327TEKTX.js.map
