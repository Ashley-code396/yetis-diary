...
var StorageNodeClient = class {
	...
	*/
	async getSliverStatus({ blobId, sliverPairIndex, sliverType }, options) {
		return (await (await this.#request(`/v1/blobs/${blobId}/slivers/${sliverPairIndex}/${sliverType}/status`, options)).json()).success.data;
	}
	/**
	...
	*/
	async getMetadataStatus({ blobId }, options) {
		return (await (await this.#request(`/v1/blobs/${blobId}/metadata/status`, options)).json()).success.data;
	}
